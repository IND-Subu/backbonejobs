...
define('DB_HOST', 'server540.iseencloud.net');
define('DB_USER', 'backbone_user');
define('DB_PASS', 'User@cpanel');
define('DB_NAME', 'backbone_bb_jobs');
...
function testDbConnection() {
    try {
        ...
        if ($db instanceof mysqli && $db->ping()) {
            ...
            return ['success' => false, 'message' => 'Unable to ping database connection'];
        }
...
// Site Configuration
define('SITE_URL', 'https://backbonejobs.xyz');
...
function requireAdminAndEmployer(){
    if (!isEmployer() && !isAdmin()) {
        jsonResponse(['success' => false, 'message' => 'Admin or Employer authentication required'], 401);
    }
}
