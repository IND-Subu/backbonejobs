...
try {
    ...
    $testJobId = 53; // Change this to a real job ID from your database
...
echo "========================================\n";
echo "1. Make sure 'google-service-account.json' exists in the same directory\n";
echo "2. Check that the service account email is added to Google Search Console\n";
echo "3. Verify that 'Web Search Indexing API' is enabled in Google Cloud Console\n";
echo "4. Ensure PHP has cURL and OpenSSL extensions enabled\n";
echo "5. Check that your server can make outbound HTTPS connections\n";
echo "\nTo check PHP extensions, run: php -m | grep -E 'curl|openssl'\n";
?>